...
╠══════════════════════════════════════════════════════════════╣
║  ✅ DONE (8)                                                 ║
║    • task-001  스키마 설계         [dba]         2h         ║
║    • task-002  예약 API           [backend]     3h         ║
║    ...                                                       ║
║                                                              ║
║  🚧 IN PROGRESS (2)                                          ║
║    • task-009  예약 화면          [frontend]   1h 진행중   ║
║    ...                                                       ║
║                                                              ║
║  ⏳ TODO (2)                                                 ║
║    • task-011  E2E 테스트        [qa]         deps:009     ║
║    ...                                                       ║
║                                                              ║
║  🚫 BLOCKED (0)                                              ║
║    _없음_                                                    ║
...
오늘의 회의 (1)
  📝 08:20  충전소 예약 기능 설계
            → .ai-company/chronicles/meetings/20260517-0820-*.md
```
